...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore SwishFolio</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>SwishFolio is a block theme for the next generation of WordPress creators. With beautiful patterns and templates built right in, you can get a site launched in record time.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h4 class="wp-block-heading has-base-color has-text-color">Download SwishFolio</h4>
<!-- /wp:heading -->
...
<p class="has-base-color has-text-color">Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the SwishFolio block theme. Anyone can do it! No coding skills required.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-primary-color has-base-background-color has-text-color has-background wp-element-button" href="https://swishfoliowp.com">Download Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
