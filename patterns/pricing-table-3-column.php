...
<p class="has-text-align-center">Easily create beautiful and responsive pricing tables with SwishFolio patterns. Connect your eCommerce solution and start making bank.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-columns alignwide are-vertically-aligned-top"><!-- wp:column {"verticalAlignment":"top","style":{"spacing":{"blockGap":"var:preset|spacing|medium","padding":{"top":"var:preset|spacing|large","right":"var:preset|spacing|large","bottom":"var:preset|spacing|large","left":"var:preset|spacing|large"}},"border":{"color":"#e3e3ea","width":"1px"}},"className":"is-style-column-box-shadow"} -->
<div class="wp-block-column is-vertically-aligned-top is-style-column-box-shadow has-border-color" style="border-color:#e3e3ea;border-width:1px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"flex","flexWrap":"nowrap","orientation":"horizontal"},"fontSize":"base"} -->
...
<p class="has-secondary-color has-text-color has-small-font-size">Great for beginners who want to give SwishFolio a trial run and see if it fits their workflow.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:list {"style":{"typography":{"lineHeight":"1.9"},"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"is-style-fancy-list is-style-check-list is-style-list-check","fontSize":"small"} -->
<ul class="is-style-fancy-list is-style-check-list is-style-list-check has-small-font-size" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;line-height:1.9"><!-- wp:list-item -->
<li>Block pattern collection</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Live editing via the Site Editor</li>
<!-- /wp:list-item -->
...
<!-- wp:list {"style":{"typography":{"lineHeight":"1.9"},"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"is-style-fancy-list is-style-check-circle-list is-style-list-check","fontSize":"small"} -->
<ul class="is-style-fancy-list is-style-check-circle-list is-style-list-check has-small-font-size" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;line-height:1.9"><!-- wp:list-item -->
<li>Everything in Essential plus...</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>All-access pattern library</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Powerful pro blocks collection</li>
<!-- /wp:list-item -->
...
<!-- wp:column {"verticalAlignment":"top","style":{"spacing":{"blockGap":"var:preset|spacing|medium","padding":{"top":"var:preset|spacing|large","right":"var:preset|spacing|large","bottom":"var:preset|spacing|large","left":"var:preset|spacing|large"}},"border":{"color":"#e3e3ea","width":"1px"}},"className":"is-style-column-box-shadow"} -->
<div class="wp-block-column is-vertically-aligned-top is-style-column-box-shadow has-border-color" style="border-color:#e3e3ea;border-width:1px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"flex","flexWrap":"nowrap","orientation":"horizontal"},"fontSize":"base"} -->
<div class="wp-block-group has-base-font-size"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"x-large","fontFamily":"primary"} -->
