...
<!-- wp:column {"verticalAlignment":"top","style":{"spacing":{"blockGap":"var:preset|spacing|medium","padding":{"top":"var:preset|spacing|large","right":"var:preset|spacing|large","bottom":"var:preset|spacing|large","left":"var:preset|spacing|large"}},"border":{"color":"#e3e3ea","width":"1px"}},"backgroundColor":"base","className":"is-style-column-box-shadow"} -->
<div class="wp-block-column is-vertically-aligned-top is-style-column-box-shadow has-border-color has-base-background-color has-background" style="border-color:#e3e3ea;border-width:1px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"flex","flexWrap":"nowrap","orientation":"horizontal"},"fontSize":"base"} -->
<div class="wp-block-group has-base-font-size"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"x-large","fontFamily":"primary"} -->
...
<p class="has-small-font-size">Now that I’ve seen how powerful the Site Editor can be, I can't live without it. SwishFolio made it super easy to get started with the “new” WordPress.</p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">I finally feel like I can ditch my costly page builder plugin. Now, I can quickly build out page sections or full page designs with SwishFolio patterns. </p>
<!-- /wp:paragraph -->
