...
<h4 class="wp-block-heading">Super simple customization</h4>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading">Pixel-perfect patterns</h4>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Your website deserves to look pixel-perfect on every device. SwishFolio ensures your entire design scales down gracefully automagically.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading">Blazing fast by default</h4>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>We obsess over performance so you don’t have to. SwishFolio is super lightweight and scores top marks on Google PageSpeed Insights.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
