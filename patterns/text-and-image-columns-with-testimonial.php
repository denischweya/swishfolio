...
<!-- wp:heading -->
<h2 class="wp-block-heading">SwishFolio is built for the new WordPress Site Editor</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Did you know you can build a blazing-fast, fully-customizable website with the native WordPress editor now? Download the SwishFolio block theme to start learning the new WordPress today!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
