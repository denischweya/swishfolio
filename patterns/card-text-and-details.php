...
<h2 class="wp-block-heading has-base-color has-text-color">Download SwishFolio for free today and start building</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"main-accent"} -->
<p class="has-main-accent-color has-text-color">SwishFolio ships with a growing collection of design patterns that cohesively click together. Drag, drop, mix, and match patterns to create stunning designs in just a few minutes. </p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button">Download SwishFolio</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<!-- wp:separator {"style":{"spacing":{"margin":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}},"backgroundColor":"secondary","className":"is-style-separator-dotted"} -->
...
<div class="wp-block-group"><!-- wp:image {"id":57,"width":75,"height":75,"sizeSlug":"full","linkDestination":"none","className":"is-style-rounded-full"} -->
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-2.webp" alt="" class="wp-image-57" width="75" height="75"/></figure>
<!-- /wp:image -->
...
<h4 class="wp-block-heading has-base-color has-text-color">Theme Details</h4>
<!-- /wp:heading -->
