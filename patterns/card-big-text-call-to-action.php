...
?>
<!-- wp:cover {"overlayColor":"main","minHeightUnit":"px","contentPosition":"center center","className":"is-style-default","style":{"color":{"duotone":"unset"},"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"}}}} -->
...
<p class="has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore SwishFolio</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"left","textColor":"base"} -->
<h2 class="wp-block-heading has-text-align-left has-base-color has-text-color">Design your site with clicks, not code.</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"main-accent"} -->
<p class="has-text-align-left has-main-accent-color has-text-color" style="font-style:normal;font-weight:400">Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the SwishFolio block theme. No coding skills required.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" href="https://swishfoliowp.com">Get Started Today →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
